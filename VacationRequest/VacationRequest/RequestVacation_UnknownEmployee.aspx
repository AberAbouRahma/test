<%@ Page Title="Request Vacation" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RequestVacation_UnknownEmployee.aspx.vb" Inherits="VacationRequest.RequestVacation_UnknownEmployee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DropDownList ID="Nametext" runat="server" DataSourceID="Employee" DataTextField="EmployeeName" DataValueField="EmployeeName"
        AutoPostBack="true" OnSelectedIndexChanged="Nametext_SelectedIndexChanged">
    </asp:DropDownList>
            <asp:SqlDataSource ID="Employee" runat="server" ConnectionString="<%$ ConnectionStrings:VacationRequestDB %>" SelectCommand="SELECT [EmployeeName] FROM [Employees] WHERE ([vacType1Balanace] &gt; 0 OR [vacType2Balanace] &gt; 0)"></asp:SqlDataSource>
            <br />
            <br />
            <br />
            <asp:Label ID="vacationTypeLabel" runat="server" Text="Vacation Type"></asp:Label>&nbsp;&nbsp;&nbsp;
    <asp:DropDownList ID="vacTypeText" AutoPostBack="true" runat="server" EnableViewState="true" OnSelectedIndexChanged="vacTypeText_SelectedIndexChanged" DataSourceID="VacationTypes" DataTextField="Name" DataValueField="Name">
