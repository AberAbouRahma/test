...
Public Class TotalsSubReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VacationRequest.TotalsSubReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTotalsSubReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TotalsSubReport = New TotalsSubReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
